...
#' ETM+ image. The GNSPI script should be provided as a .sav file.
#'
...
#' @param script_path the path to the GNSPI.sav file
...
team_fill_gaps <- function(slc_off_file, input_file, timeseries_files, 
                           script_path='GNSPI.sav', out_base=NULL, 
                           sample_size=20, size_wind=12, class_num=4, 
                           DN_min=0.0, DN_max=1.0, patch_long=1000,
                           idl="C:/Program Files/Exelis/IDL83/bin/bin.x86_64/idl.exe") {

    slc_off_file <- 'C:/Users/azvoleff/Code/TEAM/team_IDL_code/gap_fill/test data/TM20100429_toaR_gap'
    input_file <- 'C:/Users/azvoleff/Code/TEAM/team_IDL_code/gap_fill/test data/TM20100208_toaR'
    timeseries_files <- list('C:/Users/azvoleff/Code/TEAM/team_IDL_code/gap_fill/test data/TM20100515_toaR')
    script_path <- 'C:/Users/azvoleff/Code/TEAM/team_IDL_code/gap_fill/GNSPI.pro'
    out_base <- 'C:/Users/azvoleff/Code/TEAM/team_IDL_code/gap_fill/test data/TM20100429_toaR'
    sample_size <- 20
    size_wind <- 12
    class_num <- 4
    DN_min <- 0.0
    ...
    if (!(file_test('-f', script_path))) {
        stop('GNSPI.sav not found - check script_path parameter')
    }
